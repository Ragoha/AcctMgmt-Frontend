...
class HomeComponent extends Component {
  constructor(props) {
    ...
    this.state = {
      menuList: [
        { title: "회사등록", link: "acctmgmt/co" },
        { title: "사업장등록", link: "acctmgmt/div" },
        { title: "부서등록", link: "acctmgmt/dept" },
        { title: "프로젝트등록", link: "acctmgmt/co" },
        { title: "예산과목등록", link: "acctmgmt/bgtcd" },
        { title: "예산초기이월등록", link: "acctmgmt/bgticf" },
        { title: "시스템환경설정", link: "acctmgmt/syscfg" },
      ],
      searchState: false
    }
  }
